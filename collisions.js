...
Array.prototype.prase2D = function(){
...
const collisionBlocks = []          //creating collision block array

const parsedCollisions = collisionlevel1.prase2D()

parsedCollisions.forEach((row, y) => {
    row.forEach((symbol, x) => {
        if (symbol===292){
            //pushing a new collision block in array
